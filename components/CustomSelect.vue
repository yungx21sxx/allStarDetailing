<template>
	<div class="select">
		<div :class="['select__body', {
			...
			<select class="select__options" @change="emitValue">
...
export default {
	...
	methods: {
		emitValue(event) {
			this.chosenParam = event.target.value
			this.$emit('chosen-service', this.chosenParam)
		}
	},
	mounted() {
