<template>
	...
	>
		<div class="footer__left-col ">
			<article class="footer__info">
				<div class="footer__block">
					<div class="footer__header">
						...
						<address class="footer__title">г. Санкт-Петербург</address>
					</div>
					<address class="footer__text">Пискаревский пр. 119В</address>
				</div>
				<div class="footer__block">
					<div class="footer__header">
						...
						<h4 class="footer__title">Время работы:</h4>
					</div>
					<time class="footer__text">Ежедневно с 10:00 до 23:00</time>
				</div>
				...
				<div class="footer__block mail">
					<div class="footer__header">
						...
						<a class="footer__title" href="mailto:allstardetailng@gmail.com">allstardetailng@gmail.com</a>
					</div>
			...
			<p class="footer__copyright">2022 © All Star Detailing</p>
		</div>

		<v-lazy class="footer__map" transition="fade-transition">
			<iframe class="footer__map_frame"
			        frameborder="0"
