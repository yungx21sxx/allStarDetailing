		...
		<transition name="fade">
			...
			>
				...
				<form class="modal__form">
					<p class="modal__text">Оставте свои данные и пожелания к работе, чтобы получить консультацию. Вам перезвонит первый освободившийся специалсит.</p>
					<section class="modal__option" v-if="service.modal.type === 'service'">
...
// 	() => phone.value,
// 	(newValue) => {
// 		const parsedPhone = parsePhoneNumber(newValue)
